...
@Grab('org.springframework.cloud:spring-cloud-starter-bus-amqp:1.2.2.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-config:1.2.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-netflix-eureka-server:1.2.7.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-eureka:1.2.7.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-aws:1.1.4.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-security:1.1.4.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-consul-all:1.1.4.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-zookeeper-all:1.0.4.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-sleuth:1.1.4.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-contract-stub-runner:1.0.5.RELEASE')
