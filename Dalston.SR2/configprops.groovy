...
@Grab('org.springframework.cloud:spring-cloud-netflix-eureka-server:1.3.2.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-eureka:1.3.2.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-starter-zookeeper-all:1.1.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-sleuth:1.2.2.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-contract-stub-runner:1.1.2.RELEASE')
