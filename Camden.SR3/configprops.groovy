...
@Grab('org.springframework.cloud:spring-cloud-stream:1.1.0.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-bus-amqp:1.2.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-config:1.2.0.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-netflix-eureka-server:1.2.0.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-eureka:1.2.0.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-starter-consul-all:1.1.0.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-zookeeper-all:1.0.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-sleuth:1.0.9.RELEASE')
...
@Grab('org.springframework.cloud:spring-cloud-contract-stub-runner:1.0.0.RELEASE')
import org.springframework.core.io.support.PathMatchingResourcePatternResolver
@GrabResolver(name='milestone', root='http://repo.spring.io/milestone/')
@Grab('org.codehaus.groovy:groovy-json:2.4.3')
@Grab('org.springframework.cloud:spring-cloud-stream:1.1.0.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-bus-amqp:1.2.1.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-config:1.2.2.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-netflix-eureka-server:1.2.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-eureka:1.2.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-aws:1.1.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-security:1.1.3.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-consul-all:1.1.2.RELEASE')
@Grab('org.springframework.cloud:spring-cloud-starter-zookeeper-all:1.0.3.RELEASE')
